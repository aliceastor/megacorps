...
- [ ] Run existing real-PG/Chromium harnesses with isolated test data only. Capture command, commit, counts, failures and limitations in the plan execution record. Do not claim omitted checks passed.
