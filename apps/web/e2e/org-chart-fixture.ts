...
export async function fixture(page: Page, width = 1158) {
  ...
  const departments = [{ id: 'engineering', companyId, name: 'Engineering', slug: 'engineering', headAgentId: 'manager' }, { id: 'research', companyId, name: 'Research', slug: 'research', headAgentId: 'researcher' }];
  const agents = [
    ...
    { id: 'intervening', name: 'Intervening engineer', departmentId: 'engineering', positionId: 'rank-50', bossId: 'boss' },
    { id: 'researcher', name: 'Research head', departmentId: 'research', positionId: 'rank-10', bossId: 'manager' },
    { id: 'cycle-a', name: 'Legacy cycle A', departmentId: 'research', positionId: 'rank-20', bossId: 'cycle-b' },
    { id: 'cycle-b', name: 'Legacy cycle B', departmentId: 'research', positionId: 'rank-60', bossId: 'cycle-a' },
    { id: 'orphan', name: 'Legacy orphan', departmentId: 'research', positionId: 'rank-30', bossId: 'missing' },
