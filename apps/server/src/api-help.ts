...
const endpoints: ApiEndpoint[] = [
  ...
  { method: 'POST', path: '/api/agents/:id/gitea', group: 'Agents', auth: 'session', summary: 'Provision (or re-provision) the built-in Gitea identity for one agent and grant write access to every gitea-local project repo in its company. Returns the git username and token; task prompts inject them automatically. Requires GITEA_URL to be configured.', params: { id: 'Agent UUID.' } },
