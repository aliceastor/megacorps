...
const endpoints: ApiEndpoint[] = [
  ...
  { method: 'GET', path: '/api/admin/activity', group: 'Admin', auth: 'session', requiredRole: 'admin', summary: 'Read global audit records, including companyless administration and preserved company deletion history. Company-scoped activity remains filtered by visible memberships.' },
