...
const currentArchitecture = {
  ...
  sourceOfTruth: [
    ...
    'Workspace: company/project folder manager and authoritative non-coding project-file namespace. Use /workspaces/{companySlug}/{projectSlug}/deliverables/{cardId}/ for durable task deliverables; runtime-local clone/scratch paths are not shared truth.',
  ...
  surfaces: [
    ...
    { name: 'Workspace', route: '/workspaces', purpose: 'Company/project shared file authority for non-coding project files and durable deliverable paths.', primaryApi: ['/api/companies', '/api/projects', '/api/cards/:id/work-products'] },
  ...
  multiAgentNotes: [
    'Use project repoUrl and workPath as the shared coding authority; use project shared workspace paths for durable non-code deliverables; use runtime local roots only for machine-local clone/cache/scratch placement.',
  ...
  remainingGaps: [
    'Project shared file space is addressed by authority paths under /workspaces/{companySlug}/{projectSlug}/. Agents should attach durable deliverables as workProducts with project shared workspace paths or URLs; /tmp and runtime-local scratch paths are temporary only.',
