...
const endpoints: ApiEndpoint[] = [
  ...
  { method: 'POST', path: '/api/companies', group: 'Companies', auth: 'session', summary: 'Create a company.', body: { name: 'Acme AI', slug: 'acme-ai', mission: 'Build useful things.', nfsShareUrl: 'nfs://nas/megacorps optional, informational share location', dispatchIntervalSeconds: 10, autoDispatchEnabled: true } },
