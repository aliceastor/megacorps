...
const currentArchitecture = {
  model: 'MegaCorps is a company-scoped multi-agent control plane. A company owns departments, positions, agents, projects, goals, knowledge, Kanban tasks, cron runs, budget records, and logs. Agents are managed in Agents, assigned and connected through Departments, assigned reusable position prompts through Positions/Agents, and dispatched against tasks/projects through Kanban and Chat.',
  sourceOfTruth: [
    ...
    'Kanban: normalized task lifecycle, card dependency graph, action timeline, assignee/reviewer, project/goal context, work products, comments, manual run/review/decompose, and strict DELEGATE: child-card creation for agents with direct reports.',
