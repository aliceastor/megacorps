...
const currentArchitecture = {
  ...
  sourceOfTruth: [
    ...
    'Kanban: normalized task lifecycle, recursive card tree, required child policy, dependency graph, action timeline, assignee/reviewer, project/goal context, work products, message board delegation/review comments, ticket-thread actions/logs, context snapshots, manual run/review/decompose, strict DELEGATE Message Board routing, and scoped adapter-session delta prompts for repeat turns.',
